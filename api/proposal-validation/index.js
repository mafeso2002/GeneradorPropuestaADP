...
module.exports = async function (context, req) {
  ...
  const enrichedPayload = {
    ...
    aiInstructions: {
      ...
      responseFormat: "Responder en JSON valido con: status ('consistent', 'review' o 'risky'), statusLabel, planDecision ('mantener', 'cambiar' o 'validar alternativa'), planComment, missingQuestions (maximo 3), addonReview { keep, remove, add }, risks y commercialRecommendation. Tambien incluir markdownSummary con el mismo contenido en Markdown. No modificar automaticamente nada; solo recomendar. Diferenciar componentes incluidos del plan base versus add-ons/opcionales cotizables: lo incluido no es un add-on por defecto, no se selecciona ni suma precio. La modalidad virtual esta incluida; si el payload trae deliveryCharge por modalidad presencial o mixta, tratarlo como adicional operativo automatico y no pedir moverlo dentro de addonReview. Validar la progresion comercial: no recomendar escalones avanzados si faltan adopcion Microsoft 365, licencias Copilot o adopcion Copilot previa; en esos casos sugerir el escalon anterior o una primera ola. Si el plan es P0/Envisioning IA, mantener solo estos add-ons: Casos para lideres, Readiness tecnico y Webinar introductorio Copilot en 30 minutos; si se necesitan mas modulos, recomendar cambio de plan. Si el plan es P1/Productividad Digital, validarlo como programa de adopcion Microsoft 365 con diagnostico, comunicacion, formacion aplicada, acompanamiento y medicion; no reducirlo a capacitacion puntual. En P1 solo mantener como add-ons Readiness tecnico, Excel intermedio, Excel avanzado y Modulo a medida de herramienta puntual; si se necesitan mas modulos, recomendar ampliar alcance o cambiar a P2/P3. En P2/IA aplicada al trabajo, mantener add-ons de profundizacion Copilot y extensiones avanzadas cuando el caso lo justifique: Cowork y Copilot, Agents & Cowork, Agentes a medida con Copilot Studio, webinars especializados, PEAT Discovery/Build, Gobierno de IA y agentes y Foundry/Fabric/Data Readiness. En P3/Productividad Digital + IA, considerar el programa integral incluido, pero mantener como cotizables aparte Cowork y Copilot, Agentes a medida con Copilot Studio, PEAT Discovery/Build, Gobierno de IA y agentes y Foundry/Fabric/Data Readiness segun alcance. Cowork solo debe mantenerse si hay Microsoft 365 Copilot activo/trial y adopcion minima; describirlo como add-on de 3 a 5 sesiones o siguiente paso posterior a P2. Los webinars introductorios o especializados son consumos puntuales por tecnologia, no programas de adopcion completos."
    }
  };
