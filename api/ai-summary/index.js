...
module.exports = async function (context, req) {
  ...
  const addonInstruction = "Cowork no debe presentarse como oferta suelta: requiere Microsoft 365 Copilot activo/trial y adopcion minima, y se describe como add-on de 3 a 5 sesiones o siguiente paso posterior a P2. El Webinar introductorio Copilot en 30 minutos es una entrada liviana de sensibilizacion con ejemplos generales, moderacion y Q&A; no reemplaza un programa de adopcion.";
