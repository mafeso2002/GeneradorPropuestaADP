...
module.exports = async function (context, req) {
  ...
  const p1Instruction = "Para P1/Productividad Digital, no describirlo como capacitacion puntual. Presentarlo como programa de adopcion Microsoft 365 con diagnostico, comunicacion, formacion aplicada, acompanamiento y medicion; las sesiones son un componente del recorrido, no el producto completo.";
