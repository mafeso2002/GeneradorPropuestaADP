...
module.exports = async function (context, req) {
  ...
  const includedVsAddonInstruction = "Distinguir siempre componentes incluidos del plan base versus add-ons/opcionales cotizables. Lo incluido no es un add-on por defecto, no se selecciona ni se suma al precio; forma parte del alcance base del plan.";
